...
return`  ┌──⭓「 *OWNER MENU* 」
  ...
  └────────────⭓
   ...
   ┌──⭓「 *BUG MENU* 」
   │
   │⭔ ${prefix}virtex✓ ${feat("virtex")? yes :no}
   │⭔ ${prefix}sendbugv1✓ ${feat("sendbugv1")? yes :no}
   │⭔ ${prefix}sendbugv2✓ ${feat("sendbugv2")? yes :no}
   │⭔ ${prefix}sendbugv3✓ ${feat("sendbugv3")? yes :no}
   ...
   │⭔ ${prefix}bugkatalogv1✓ ${feat("bugkatalogv1")? yes :no}
   │⭔ ${prefix}bugkatalogv2✓ ${feat("bugkatalogv2")? yes :no}
   │⭔ ${prefix}bugkatalogv3✓ ${feat("bugkatalogv3")? yes :no}
   │⭔ ${prefix}bugkatalogv4✓ ${feat("bugkatalogv4")? yes :no}
